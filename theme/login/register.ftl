          ...
          <#if !realm.registrationEmailAsUsername>
            <div class="${properties.kcFormGroupClass!} ${messagesPerField.printIfExists('username',properties.kcFormGroupErrorClass!)}">
                <div class="${properties.kcLabelWrapperClass!}">
                    ...
                    <p class="registration-help">Your username, visible to other members. May contain letters, numbers, underscores and dashes, e.g. john_smith or Xx_coolkid_420_xX</p>
                </div>
            ...
            <div class="${properties.kcFormGroupClass!} ${messagesPerField.printIfExists('firstName',properties.kcFormGroupErrorClass!)}">
                <div class="${properties.kcLabelWrapperClass!}">
                    ...
                    <p class="registration-help">Your legal first name, e.g. Jonathan</p>
                </div>
                <div class="${properties.kcInputWrapperClass!}">
            ...
            <div class="${properties.kcFormGroupClass!} ${messagesPerField.printIfExists('nickName',properties.kcFormGroupErrorClass!)}">
                ...
                <div class="${properties.kcInputWrapperClass!}">
                    <input type="text" id="user.attributes.nickName" class="${properties.kcInputClass!}" name="user.attributes.nickName" value="${(register.formData['user.attributes.nickName']!'')}" />
                </div>
            </div>
            ...
            <div class="${properties.kcFormGroupClass!} ${messagesPerField.printIfExists('lastName',properties.kcFormGroupErrorClass!)}">
                <div class="${properties.kcLabelWrapperClass!}">
                    ...
                    <p class="registration-help">Your last name, e.g. Smith</p>
                </div>
                <div class="${properties.kcInputWrapperClass!}">
            ...
            <div class="${properties.kcFormGroupClass!} ${messagesPerField.printIfExists('email',properties.kcFormGroupErrorClass!)}">
                <div class="${properties.kcLabelWrapperClass!}">
                    ...
                    <p class="registration-help">Your email address, e.g. john.smith@example.com</p>
                </div>
                <div class="${properties.kcInputWrapperClass!}">
